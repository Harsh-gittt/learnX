...
const StudentHero = () => {
  return (
    <div className='relative flex-1 px-30'>
      ...
      <div className='fixed bottom-8 right-6 flex justify-center items-center text-2xl font-bold text-white w-1/6 h-20 shadow-2xl shadow-black bg-black rounded-2xl transition-all 300 hover:scale-110 cursor-pointer'>Explore Courses</div>
    </div>
  )
}
